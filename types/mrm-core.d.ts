...
declare module 'mrm-core' {
  ...
  // npm
  function install(deps: string | string[] | Dependencies, options?: NpmOptions, exec?: Function) : void;
  function uninstall(deps: string | string[], options?: NpmOptions, exec?: Function) : void;
